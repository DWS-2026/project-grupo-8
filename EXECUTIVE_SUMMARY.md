...
|---|------|-----------|--------|----------|
| **4** | JWT Secret Regenera Cada Restart | `JwtTokenProvider.java:20` | Tokens inválidos tras reinicio | 7.5 |
...
|---|------|-----------|--------|------|
| **5** | JWT Secret Regenera Cada Restart | `JwtTokenProvider.java:20` | Tokens inválidos tras reinicio | 7.5 |
| **8** | No Hay Rate Limiting | `UserRestController.java:49` | Fuerza bruta ilimitada | 7.1 |
| **9** | SSRF Parcialmente Validado | `HtmlSanitizer.java:100` | Acceso a recursos internos | 5.3 |
...
### MAÑANA (1-2 horas)
- ✅ Extraer JWT secret a variables de entorno
...
### 3. JWT
El filtro JWT ya está activo en `WebSecurityConfig.java`; el punto pendiente sigue siendo el secreto persistente.
...
| Problema | Solución |
|----------|----------|
| Tokens JWT rechazados | Verificar JWT_SECRET coincide en todos servidores |
